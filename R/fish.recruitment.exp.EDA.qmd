...
```{r fish EDA temporal hump what patches, results = "markdown", eval = TRUE}
```
Plot DM4 was the highest in both species richness and total abundance at the peak (day 7 and 9)
