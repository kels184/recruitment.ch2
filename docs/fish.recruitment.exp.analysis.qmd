...
### Model Investigation
```{r recruitment univariate abundance summary, results = 'markdown', eval = TRUE}
...
Planned contrasts: In frequentist analyses you can make nlevels - 1 contrasts without p adjustment - as long as they're independent.
