...
```{r recruitment univariate abundance fit brm1a, results = 'markdown', eval = FALSE, error = TRUE, cache = TRUE}
```

```{r recruitment univariate abundance brm1a vars, results = 'markdown', eval = TRUE, error = TRUE}
